...
Future<void> main() async {
  group('UnifiedAnimationParentComponent', () {
    ...
    testWithFlameGame('clears instances if needed (manual check)', (
      ...
      parent.addInstance(position: Vector2.zero(), size: Vector2.all(10));
    ...
    testWithFlameGame(
      ...
      (game) async {
        ...
        parent.addInstance(position: Vector2(0, 100), size: Vector2.all(10));
        parent.addInstance(position: Vector2(0, 50), size: Vector2.all(10));
